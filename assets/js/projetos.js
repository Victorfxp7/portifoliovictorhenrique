function projetos(section) {
  section.innerHTML = `<header>
    ...
    <div class="content">
      ...
      <!-- Projeto 1: Número secreto -->
        <div class="card">
          <h3>Número secreto</h3>
          <div class="img-wrapper">
            <img
              src="./projects/numerosecreto.gif"
              alt="GIF do projeto.número secreto"
            />
            <div class="buttons">
              <!-- Link Github -->
          ...
          <p>Jogo com objetivo de acertar o número gerado. </p>
        ...
        <div class="card">
          ...
          <p>Calculadora desenvolvida para praticar algoritmos lógicos e operadores,</p>
          <p class="languages">HTML - CSS - JS </p>
        </div>

        <!-- Projeto 3: codeCasino -->
        <div class="card">
          <h3>codeCassino</h3>
          <div class="img-wrapper">
            <img
              src="./projects/codeCassino.gif"
              alt="GIF do projeto.casino"
            />
            <div class="buttons">
              <!-- Link Github -->
              <a href="https://github.com/squad-30/OrangeEvolution-Squad30" target="_blank" title="Repositório no Github">
          ...
          <p>Projeto de jogo de cassino desenvolvido para praticar lógica de programação, manipulação de eventos e geração de números aleatórios</p>
          <p class="languages">HTML - CSS - JS </p>
        </div>
